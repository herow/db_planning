      ...
      gotoValidator(new QIntValidator(0, 0, this))
{
    ...
    //remove some submenus of file menu
    ui->fileMenu->removeAction(ui->fileAttachAction);
    ui->fileMenu->removeAction(ui->fileCloseAction);
    ui->fileMenu->removeAction(ui->fileSaveAction);
    ui->fileMenu->removeAction(ui->fileRevertAction);
    ui->fileMenu->removeAction(ui->fileCompactAction);
    ui->fileMenu->removeAction(ui->actionEncryption);
    ui->fileMenu->removeAction(ui->actionLoadExtension);
    ui->fileMenu->removeAction(ui->actionOpenProject);
    ui->fileMenu->removeAction(ui->actionSaveProject);

    //remove some submenus of view menu
    ui->viewMenu->removeAction(ui->viewDBToolbarAction);
    ui->viewMenu->removeAction(ui->viewPreferencesAction);

    //remove help menu
    ui->menubar->removeAction(ui->helpMenu->menuAction());
